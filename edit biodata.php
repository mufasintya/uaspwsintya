...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			...
			<div class="collapse navbar-collapse" nim="navbarSupportedContent">
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_GET['nim'])){
			...
			$select = mysqli_query($koneksi, "SELECT * FROM biodata WHERE nim='$nim'") or die(mysqli_error($koneksi));
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE biodata SET nim='$nim', nama='$nama', jurusan='$jurusan', alamat='$alamat' WHERE nim='$nim'") or die(mysqli_error($koneksi));
			
			if($sql){
				echo '<script>alert("Berhasil menyimpan data."); document.location="edit biodata.php?nim='.$nim.'";</script>';
			}else{
		...
		<form action="edit biodata.php?nim=<?php echo $nim; ?>" method="post">
